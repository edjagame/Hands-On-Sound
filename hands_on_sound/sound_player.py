...
from hands_on_sound.paths import SOUNDS_DIR


class SoundPlayer:
    scales = ("C", "D", "E", "G", "A", "B", "F#", "C#", "Ab", "Eb", "Bb", "F")
    modes = ("Major", "Minor")
    def __init__(self, sounds_folder = SOUNDS_DIR, scale = "C", mode = "Major"):
        pygame.mixer.init()

        self.scale = scale
        self.mode = mode

        self.sounds_folder = os.fspath(sounds_folder)
    ...
    def load_sounds(self, instrument, scale = "C", mode = "Major"):
        # Load every available sample for the requested instrument and scale.
    ...
    def get_notes(self, scale, mode) -> list:
        # Use the scale spelling that matches the sample filenames.
        major = {
            "C": ["C", "D", "E", "F", "G", "A", "B"],
            "D": ["D", "E", "F#", "G", "A", "B", "C#"],
            "E": ["E", "F#", "G#", "A", "B", "C#", "D#"],
        ...
        # Rotate the list so the root note is first.
        if "C" in scale_notes:
    ...
    def get_note_names(self, scale, mode) -> list:
        # Return note names with key-appropriate spelling for the on-screen guide.
        major = {
            "C": ["C", "D", "E", "F", "G", "A", "B"],
            "D": ["D", "E", "F#", "G", "A", "B", "C#"],
            "E": ["E", "F#", "G#", "A", "B", "C#", "D#"],
